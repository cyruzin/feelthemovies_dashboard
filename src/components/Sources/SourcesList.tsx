    ...
    <Section>
      ...
      >
        <p>
          ...
          <strong>{source && source.name}</strong> source?
        </p>
      </Modal>
      <Link
      ...
      <Table columns={tableColumns}>
        {data.map((source) => (
          <TR key={source.id}>
            ...
            <TD>{source.name}</TD>
            <TD>
              {distanceInWordsStrict(parseISO(source.created_at), Date.now())}
            </TD>
            <TD>
              {distanceInWordsStrict(parseISO(source.updated_at), Date.now())}
            </TD>
            <TD>
              <Link
