    ...
    <>
      ...
      <Content>
        <Switch>
          ...
          />
          <Route
            path="/dashboard/edit_recommendation/:id"
            component={RecommendationsEdit}
          />
          <Route
            path="/dashboard/search_recommendation"
            component={RecommendationsSearch}
          />

          <Route path="/dashboard/items/:id" component={RecommendationItems} />
          <Route
            path="/dashboard/create_item/:id"
            component={RecommendationItemsCreate}
          />
          <Route
            path="/dashboard/edit_item/:id"
            component={RecommendationItemsEdit}
          />
